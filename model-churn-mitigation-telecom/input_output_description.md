...
## Output
- Output: a JSON list of objects containing all the 'ACCOUNT_ID' and "SUB_ID" in the input, with one more column added named 'SCORE' which contains model's prediction of the churn score for the subscriber. **__Reference file: sample.zip.out__**
