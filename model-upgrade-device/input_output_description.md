...
## Output
- Output: a JSON list of objects containing all the 'ACCOUNT_ID' and "SUB_ID" in the input, with one more column added named 'SCORE' which contains model's prediction of the likelihood of a subscriber's probability of upgrading device in telecom industry. **__Reference file: sample.zip.out__**
